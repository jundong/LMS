...
#set chassisIpList [list "10.61.36.100"]
        ...
        foreach physicalTestModule $physicalTestModuleList {
            ...
            if {1} {
                ...
                if {$opcode == "insert"} {
                    ...
                    set results [::mysql::sel $::dbConn "SELECT DISTINCT SerialNum,PortCount FROM stc_inventory_testmodule \
                    ...
                    if {$results == ""} {
                        ...
                        if {$physicalTestModuleInfo(-Status) != "MODULE_STATUS_UNKNOWN"} {
                            ...
                            if {$SerialNum == $testModuleInfo($hostIp,$index,-SerialNum) || $PortCount == $testModuleInfo($hostIp,$index,-PortCount)} {
                                set command "UPDATE"
                            } else {
