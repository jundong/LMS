...
<html>
	<head>
		...
		<script src="/iprep/common/mootools.js" type="text/javascript"
			charset="utf-8"></script>
		<script src="/iprep/common/calendar.rc4.js" type="text/javascript"
			charset="utf-8"></script>
		<link rel="stylesheet" href="/iprep/common/css/style.css"
			type="text/css" media="screen" />
		<link rel="stylesheet" type="text/css"
			href="/iprep/common/css/calendar.css" media="screen" />
	...
	<body>
		<div class="content">
			...
			<div name="divloaner" id="divloaner" style="display: <%=loaDisState%>">
				<form method=post
					action="/iprep/property.do?isLoaner=true&Ip=<%=Ip%>&Slot=<%=Slot%>&SN=<%=SN %>&ResourceType=<%=ResourceType %>">
			...
			<div name="divpermanent" id="divpermanent" style="display: <%=perDisState%>">
				<form method=post
					action="/iprep/property.do?isPermanent=true&Ip=<%=Ip%>&Slot=<%=Slot%>&SN=<%=SN %>&ResourceType=<%=ResourceType %>">
					<table BORDER=0 CELLPADDING="0" CELLSPACING="0" align="left"
						width="100%">
						<tr>
							<td>
