...
<html>
	<head>
		...
		<script type="text/javascript">                      
             function updateVM() {
             	updateform.action="/iprep/updatevmnotes.do?isVM=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }  
             function updateVMClient() {
             	updateform.action="/iprep/updatevmnotes.do?isVMClient=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }  
            function updatePC() {
             	updateform.action="/iprep/updatevmnotes.do?isPC=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }
             function updateDUT() {
             	updateform.action="/iprep/updatevmnotes.do?isDUT=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }  
             function updateDUTSerPort() {
             	updateform.action="/iprep/updatevmnotes.do?isDUTSerPort=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }               
            function updateDUTIntf() {
             	updateform.action="/iprep/updatevmnotes.do?isDUTIntf=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             } 
            function updateChassis() {
             	updateform.action="/iprep/updatevmnotes.do?isChassis=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             } 
            function updateModule() {
             	updateform.action="/iprep/updatevmnotes.do?isModule=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }  
            function updatePort() {
             	updateform.action="/iprep/updatevmnotes.do?isPort=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }  
            function updateAv() {
             	updateform.action="/iprep/updatevmnotes.do?isAV=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }  
            function updateAvPort() {
             	updateform.action="/iprep/updatevmnotes.do?isAVPort=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }                                                                                   
        </script>
