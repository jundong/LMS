...
<%
	if (!request.getSession().getAttribute("levels").toString().equals(
		...
		//out.println("window.open('/iprep/login.jsp','_top');");
		//out.println("</script>");
		response.sendRedirect("/iprep/warning.jsp");
	}
%>
	...
	<body>
		<div class="content">
			...
			<table  border="0" cellpadding="0" cellspacing="0"
				...
				<tr bgcolor="#C2D5FC">
					<td>
						<form method="post" action="admin.do?isAddUser=true">
							...
							<input type="submit" border="0" value="Add Spirent User"
								style="width: 150px" />
						</form>
					</td>
				</tr>
				...
				<tr bgcolor="#C2D5FC">
					<td>
						<form method="post" action="admin.do?isAddOtherUser=true">
							UserName:
							...
							<input type="text" border="0" name="email"
								style="width: 100px" />
							<input type="submit" border="0" value="Add Non-Spirent User"
								style="width: 200px" />
						</form>
					</td>
				</tr>
