...
<html>
	<head> 
		...
		<script type="text/javascript">
             ...
             function addChassis() {
             	addform.action="/iprep/addresource.do?isChassis=true";
			    addform.target="basefrm";
			    addform.submit();  
             }
             
             function addDUT() {
                addform.action="/iprep/update/updatedut.jsp";
			    addform.target="basefrm";
			    addform.submit();  
             }
             
             function addDUTIntf() {
                addform.action="/iprep/update/updatedutintf.jsp";
			    addform.target="basefrm";
			    addform.submit();  
             }             
             
             function addAV() {
             	addform.action="/iprep/addresource.do?isAV=true";
			    addform.target="basefrm";
			    addform.submit();  
             }
   
             function addPC() {
             	addform.action="/iprep/addresource.do?isPC=true";
			    addform.target="basefrm";
			    addform.submit();  
             }   
             
             function addVM() {
             	addform.action="/iprep/addresource.do?isVM=true";
			    addform.target="basefrm";
			    addform.submit();  
             }                                       
        </script>
