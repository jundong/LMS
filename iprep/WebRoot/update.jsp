	...
	<head>
		...
		<script type="text/javascript">           
             function updateChassis() {
             	updateform.action="/iprep/updateresource.do?isChassis=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }
             
             function updateDUT() {
                updateform.action="/iprep/updateresource.do?isDUT=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }
             
             function updateAV() {
             	updateform.action="/iprep/updateresource.do?isAV=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }
             
             function updateVM() {
             	updateform.action="/iprep/updateresource.do?isVM=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }
             
             function updatePC() {
             	updateform.action="/iprep/updateresource.do?isPC=true";
			    updateform.target="basefrm";
			    updateform.submit();  
             }                                                    
        </script>
