	...
	<head>
		...
		<script type="text/javascript">
			function generateResourcesReport(){
			    generateReport.action="/iprep/utilizationreport.do?isResourcesReport=true&isEmpty=<%=isEmpty%>";
			    generateReport.target="basefrm";
			    generateReport.submit();  
			}

			function generateUserReport(){
			    generateReport.action="/iprep/utilizationreport.do?isUserReport=true&isEmpty=<%=isEmpty%>";
			    generateReport.target="basefrm";
			    generateReport.submit();  
			}
        </script>
