		...
		<script type="text/javascript">
    			function getReservation(){
			     ...
			     if (selectedList == "") {
                  ...
                  tree_menu_form.action="/iprep/scheduler/scheduler.jsp";
                  tree_menu_form.target="basefrm";
			      tree_menu_form.submit(); 
			      //window.open("/iprep/scheduler/scheduler.jsp?portList="+portList, "basefrm");     
			}
    		...
    		function myReservations(){
                  ...
                  tree_menu_form.target="basefrm";
			      tree_menu_form.submit(); 
			      //window.open('/iprep/scheduler/scheduler.jsp', 'basefrm') 
			}
    </script>
	</head>
