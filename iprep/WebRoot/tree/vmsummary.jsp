		...
		<div class="content">
			...
			<table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a
							HREF="/iprep/tree/vmsummary.jsp?Site=<%=rs.getString("Site")%>"><%=rs.getString("Site")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/iprep/update.jsp?VMIp=<%=rs.getString("VMClient")%>"><%=rs.getString("Dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/iprep/tree/vmclient.jsp?Ip=<%=rs.getString("VMClient")%>"><%=rs.getString("VMClient")%>&nbsp;&nbsp;</a>
					</td>
					<td>
