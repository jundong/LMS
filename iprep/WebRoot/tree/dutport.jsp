		...
		<div class="content">
			...
			<table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a HREF="/iprep/update.jsp?DUTIp=<%=rs.getString("DutIpAddress")%>" target="_parent"><%=rs.getString("Dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<%=rs.getString("DutName")%>&nbsp;&nbsp;
					</td>					
					<td>
						<a HREF="/iprep/tree/dutIntf.jsp?Ip=<%=rs.getString("DutIpAddress")%>" target="_parent"><%=rs.getString("DutIpAddress")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<%=rs.getString("Pid")%>&nbsp;&nbsp;
					</td>
					...
					<td>
						<a HREF="/iprep/update/notes.jsp?DUTIntfName=<%=rs.getString("IntfName")%>&DUTIntfIp=<%=rs.getString("DutIpAddress")%>&DUTIntfNotes=<%=rs.getString("Notes")%>" target="_parent"><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>
					<td>
