	...
	<body>
		<div class="content">
			...
			<%
				...
				//System.out.println(CAL + ":" + CHN +":" + HNL +":" + RTP +":" + SNV +":" + ALL);
				String checkedSite = "";
				if (CAL != null && CAL != "false") {
				    checkedSite = checkedSite + "CAL" + ",";
				    calstate = "checked";
				}
				if (CHN != null && CHN != "false") {
				    checkedSite = checkedSite + "CHN" + ",";
				    chnstate = "checked";
				}
				if (HNL != null && HNL != "false") {
				    checkedSite = checkedSite + "HNL" + ",";
				    hnlstate = "checked";
				}
				if (RTP != null && RTP != "false") {
				    checkedSite = checkedSite + "RTP" + ",";
				    rtpstate = "checked";
				}
				if (SNV != null && SNV != "false") {
				...
				if (checkedSite != null && !checkedSite.trim().equals(""))
                	request.getSession().setAttribute("checkedsite", checkedSite);
                if (request.getSession().getAttribute("checkedsite")!= null &&
                !request.getSession().getAttribute("checkedsite").toString().equals("")) {
	                String Site = (String) request.getSession().getAttribute("checkedsite");
					...
					<td>
						<div name="type" id="type">
							...
							<select name="resourcetype"
								...
								<option value="stc" selected>
									Chassis
								</option>
								<option value="stcmodule">
									STC Module
								</option>
								<option value="stcport">
									STC Port Groups
								</option>
								<option value="dut">
									DUT
								</option>
								<option value="dutmodule">
									DUT Blade
								</option>
								<option value="pc">
								    PC
					...
					<td>
						<div name="chassis" id="chassis">
							<form method="post" align="left" name="form2"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="button" value="Search Chassis" onclick="return submitForm();"/>
							</form>
						</div>

						<div style="display: none" name="dut" id="dut">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search DUT" />
							</form>
						</div>

						<div style="display: none" name="module" id="module">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search Test Modules" />
							</form>
						</div>

						<div style="display: none" name="dutintf" id="dutintf">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search DUT Intf" />
							</form>
						</div>

						<div style="display: none" name="portgroup" id="portgroup">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search Port Groups" />
							</form>
						</div>

						<div style="display: none" name="vmware" id="vmware">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search VMware" />
							</form>
						</div>

						<div style="display: none" name="vmwareclient" id="vmwareclient">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search VMware Client" />
							</form>
						</div>
						
						<div style="display: none" name="appliance" id="appliance">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search Avalanche" />
							</form>
						</div>
						
						<div style="display: none" name="avportgroup" id="avportgroup">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search Av Port" />
							</form>
						</div>

						<div style="display: none" name="pc" id="pc">
							<form method="post" align="left"
								...
								<input type="text" name="conditionValue" maxlength="50" value=""
									style="width: 120px" />
								<input type="submit" value="Search PC" />
							</form>
						</div>	
						
						<div style="display: none" name="stcproperty" id="stcproperty">
							<form method="post" align="left"
