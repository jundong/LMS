...
public class SendMail {
	...
	private Vector<String> attachedFileList = null;
	@SuppressWarnings("unused")
...
//		mailFrom = "TestManager";
	...
	public void sendMail(SendMail sm, String msg, String smtpHost, String mailTo, String mailFrom, String subject,Vector<String> imageList)

	{
		try {
			...
			sm.setAttachedFileList(imageList);
			sm.sendMail();
		} catch (Exception e) {
