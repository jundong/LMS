    ...
    public void run() {
	    ...
	    try {     
			...
			if (conn != null) {
			   ...
			   sqlStr = "select domainname, mail from iprep_users where loanerreceive='1'";
			   rs = stmt.executeQuery(sqlStr);
			   while (rs.next() && isSendNotification){
					...
					String subject = "iPREP Lab Management System Loaner Expire Reminder";
					 String contentMsg = "Dear " + fullName + ", <br><br>";
						...
						contentMsg = contentMsg + "Please access <a href='http://englabmanager/iprep/index.jsp'>[here]</a> for more information.";	
					
		    		SendMail sm = new SendMail();
		    		sm.sendMail(sm, contentMsg, "smtp.spirentcom.com", rs.getString("mail"), "lms@spirentcom.com", subject,null);
			  }
		}
	 } catch (Exception e) {
