...
public class QueryResource extends HttpServlet {
	...
	throws ServletException, IOException {
		try {
			...
			response.sendRedirect("/inventory/query.jsp?type="+type+"&checkedSite="+checkedSite+"&redirect=true&conditionValue=" + conditionValue
					+ "&conditionItem=" + conditionItem);
		} catch (Exception e) {
			System.out.println("Error occourred in QueryResource.java: "
							+ e.getMessage());
			response.sendRedirect("/inventory/query.jsp");
		}
   }
