				...
				if (isPermanent != null){
					...
					if (!so.equals("")){
						if (!Slot.equals("")) {
							...
							response.sendRedirect("/inventory/tree/slot.jsp?Ip=" + Ip + "&Slot=" + Slot);
						} else {
							...
							stmt.execute(SQLstmt);
							response.sendRedirect("/inventory/tree/chassis.jsp?Ip=" + Ip);
						}
						...
						response.sendRedirect("/inventory/update/chassisproperty.jsp?Ip=" + Ip + "&Slot=" + Slot + "&Property=Permanent" + "&ResourceType=" + ResourceType);
					}		
					...
					if (!so.equals("") && !sostart.equals("") && !soend.equals("")){
						...
						response.sendRedirect("/inventory/update/chassisproperty.jsp?Ip=" + Ip + "&Slot=" + Slot + "&Property=Loaner"  + "&ResourceType=" + ResourceType);
					}
				}
			}
		} catch (Exception e) {
