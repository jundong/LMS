...
public class TimerListener implements ServletContextListener {
    private Timer updateChassisCal = null;
    private Timer updateChassisChn = null;
    private Timer updateChassisHnl = null;
    private Timer updateChassisSnv = null;
    private Timer updateChassisRtp = null;
	...
	public void contextDestroyed(ServletContextEvent event) {
		updateChassisCal.cancel();
		updateChassisChn.cancel();
		updateChassisHnl.cancel();
		updateChassisSnv.cancel();
		updateChassisRtp.cancel();
		updateAV.cancel();
		sendReminder.cancel();
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		updateChassisCal = new Timer(true);
		updateChassisHnl = new Timer(true);
		updateChassisSnv = new Timer(true);
		updateChassisChn = new Timer(true);
		updateChassisRtp = new Timer(true);
		...
		updateChassisCal.schedule(new UpdateChassisCal(event.getServletContext()),30*60*1000,updateDBTime*60*1000);
		updateChassisHnl.schedule(new UpdateChassisHnl(event.getServletContext()),30*60*1000,updateDBTime*60*1000);
		updateChassisChn.schedule(new UpdateChassisChn(event.getServletContext()),30*60*1000,updateDBTime*60*1000);
		updateChassisRtp.schedule(new UpdateChassisRtp(event.getServletContext()),30*60*1000,updateDBTime*60*1000);
		updateChassisSnv.schedule(new UpdateChassisSnv(event.getServletContext()),30*60*1000,updateDBTime*60*1000);
