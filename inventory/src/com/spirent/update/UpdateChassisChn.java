...
public class UpdateChassisChn extends TimerTask {
	private ServletContext context = null;
	
	public UpdateChassisChn(ServletContext context){
    ...
    public void run() {	   
    	   try {
				...
				String cmdStr = "";
			    cmdStr = "cmd /c tclsh  " + InitBaseParameters.getTclPath() + "scan_chn.tcl";
			    ...
			    process = null;
	   		   ...
	   		   System.out.println("Error occurred in scan_chn.tcl!");
			    e.printStackTrace();
	       }
    }
}
