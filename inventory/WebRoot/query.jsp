...
<html>
	...
	{
		window.open("/inventory/download.jsp?filename=ExportResults", "_self");
	}
	
	function isInventoryExport()
	{
		window.open("/inventory/download.jsp?filename=ExportInventory", "_self");
	}
		...
		<div class="content">
			...
			<table BORDER=0 CELLPADDING="0" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a
							HREF="/inventory/tree/chassis.jsp?Site=<%=rs.getString("Site")%>"><%=rs.getString("Site")%>&nbsp;&nbsp;</a>
					</td>
					<td>
					...
					<td>
						<a
							HREF="/inventory/tree/slot.jsp?Ip=<%=rs.getString("Hostname")%>"><%=rs.getString("Hostname")%>&nbsp;&nbsp;</a>
					</td>
					...
					<td>
						<a HREF="/inventory/update/chassisproperty.jsp?Ip=<%=rs.getString("Hostname")%>&Property=<%=rs.getString("Property")%>&SOEnd=<%=rs.getString("SOEnd")%>&SO=<%=rs.getString("SO")%>&SOStart=<%=rs.getString("SOStart")%>&LoanerNotificationDate=<%=rs.getString("LoanerNotificationDate")%>&SN=<%=rs.getString("SerialNum")%>&ResourceType=<%=rs.getString("ControllerHwVersion")%>"><%=rs.getString("Property")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<%=rs.getString("SO")%>&nbsp;&nbsp;
					</td>
					...
					<td>
						<a HREF="/inventory/update/notes.jsp?ChIP=<%=rs.getString("Hostname")%>&ChNotes=<%=rs.getString("Notes")%>" ><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>						
			...
			<table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a HREF="/inventory/tree/dut.jsp?Site=<%=rs.getString("Site")%>"><%=rs.getString("Site")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/inventory/update.jsp?DUTIp=<%=rs.getString("DutIpAddress")%>"><%=rs.getString("Dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<%=rs.getString("DutName")%>&nbsp;&nbsp;
					</td>					
					<td>
						<a
							HREF="/inventory/tree/dutIntf.jsp?Ip=<%=rs.getString("DutIpAddress")%>"><%=rs.getString("DutIpAddress")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/inventory/tree/dut.jsp?Vendor=<%=rs.getString("Vendor")%>"><%=rs.getString("Vendor")%>&nbsp;&nbsp;</a>
					</td>
					...
					<td>
						<a HREF="/inventory/update/notes.jsp?DutSerialIp=<%=rs.getString("DutIpAddress")%>"><%=rs.getString("SerialPortAccess")%>&nbsp;&nbsp;</a>
					</td>						
					<td>
						<a HREF="/inventory/update/notes.jsp?DutIp=<%=rs.getString("DutIpAddress")%>&DutNotes=<%=rs.getString("Notes")%>"><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>
					<td>
