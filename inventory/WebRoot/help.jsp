...
body {
	...
	<body>
		<div class="content">
			...
			<p>
				<img src="/inventory/common/imgs/componects.gif"
			...
			<img src="/inventory/common/imgs/database.gif"
			...
			<p>
				Tree view page:
				<A href="/inventory/index.jsp">Spirent Lab Management System</A>.
			</p>
			...
			<img src="/inventory/common/imgs/treeview.gif"
				alt="Inventory Components">
			<p>
			...
			<img src="/inventory/common/imgs/queryinterface.gif"
				alt="Query Interface">
			...
			<img src="/inventory/common/imgs/administration.gif"
				alt="Administration">
			<p>
				<br>
			</p>
