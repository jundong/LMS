		...
		<div class="content">
			...
			<table BORDER="0" CELLPADDING="0" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a HREF="/inventory/update.jsp?AVIp=<%=rs.getString("ipaddress")%>" target="_parent"><%=rs.getString("dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/inventory/tree/avport.jsp?Ip=<%=rs.getString("ipaddress")%>" target="_parent"><%=rs.getString("ipaddress")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<%=rs.getString("model")%>&nbsp;&nbsp;
					</td>
					<td>
						<a
							HREF="/inventory/tree/avport.jsp?Ip=<%=rs.getString("ipaddress")%>&Index=<%=rs.getString("portindex")%>" target="_parent"><%=rs.getString("portindex")%>&nbsp;&nbsp;</a>
					</td>
					<td>
...
<%
					...
					<td>
						<a HREF="/inventory/update/notes.jsp?AVPortIp=<%=rs.getString("ipaddress")%>&AVPortGP=<%=rs.getString("portgroupindex")%>&AVPort=<%=rs.getString("portindex")%>&AVPortNotes=<%=rs.getString("Notes")%>" target="_parent"><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>						
					<td>
