		...
		<div class="content">
			...
			<table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a
							HREF="/inventory/tree/vmhost.jsp?Site=<%=rs.getString("Site")%>" target="_parent"><%=rs.getString("Site")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/inventory/update.jsp?VMIp=<%=rs.getString("VMHost")%>" target="_parent"><%=rs.getString("Dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a HREF="/inventory/tree/cssummary.jsp?VMHostName=<%=rs.getString("VMHostName")%>" target="_parent"><%=rs.getString("VMHostName")%>&nbsp;&nbsp;</a>
					</td>	
					<td>
						<a HREF="/inventory/tree/cssummary.jsp?VMHostName=<%=rs.getString("VMHostName")%>" target="_parent"><%=rs.getString("VMHost")%>&nbsp;&nbsp;</a>
					</td>	
					<td>
...
<%
					...
					<td>
						<a HREF="/inventory/update/notes.jsp?ClientIp=<%=rs.getString("VMClient")%>&ClientNotes=<%=rs.getString("Notes")%>" target="_parent"><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>
					<td>
