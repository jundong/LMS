		...
		<div class="content">
			...
			<table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a HREF="/inventory/tree/av.jsp?Site=<%=rs.getString("site")%>"><%=rs.getString("site")%>&nbsp;&nbsp;</a>
					</td>
					<td>
						<a
							HREF="/inventory/update.jsp?AVIp=<%=rs.getString("ipaddress")%>"><%=rs.getString("dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
					...
					<td>
						<a
							HREF="/inventory/update/notes.jsp?AVIp=<%=rs.getString("ipaddress")%>&AVNotes=<%=rs.getString("Notes")%>"><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>
					<td>
