		...
		<div class="content">
			...
			<table BORDER="0" CELLPADDING="1" CELLSPACING="0" align="left"
				...
				<tr bgcolor=<%=color%>>
					...
					<td>
						<a
							HREF="/inventory/tree/pc.jsp?Site=<%=rs.getString("Site")%>" target="_parent"><%=rs.getString("Site")%>&nbsp;&nbsp;</a>
					</td>
					<td>
					...
					<td>
						<a HREF="/inventory/update.jsp?PCIp=<%=rs.getString("DNSHostName")%>" target="_parent"><%=rs.getString("Dept")%>&nbsp;&nbsp;</a>
					</td>
					<td>
...
<%
					...
					<td>
						<a HREF="/inventory/update/notes.jsp?DNSHostName=<%=rs.getString("DNSHostName")%>&DNSHostNotes=<%=rs.getString("Notes")%>" target="_parent"><%=rs.getString("Notes")%>&nbsp;&nbsp;</a>
					</td>																
					<td>
