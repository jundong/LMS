...
#set HNLIpList [list 10.14.6.185]
#
##set HNLIpList [list \
#    10.14.16.125    \
#    10.14.16.110    \
...
#
#
##append chassisIpList $HNLIpList " " $CALIpList " " $RTPIpList " " $SNVIpList " " $CHNIpList
#append chassisIpList  $HNLIpList
#append chassisIpList  $RTPIpList
#append chassisIpList  $CHNIpList
#append chassisIpList  $SNVIpList
...
while {1} {
    ...
    # Get all DUT IP addresses from DB
    set chassisIpList [::mysql::sel $::dbConn \
...
close $fid
    ...
    #wait for 60 minutes are update the system again 
