	...
	<body>
		<div class="content">
			...
			<%
				...
				try {
			        ...
			        if (conn != null) {
						...
						String SQLstmt = "SELECT domainname, mail FROM users WHERE username='" + request.getSession().getAttribute("username") + "'";
						...
						comment = comment + "<br>";
						comment = comment + "If you want to use Spirent Lab Management System, use the link <a href='http://englabmanager/inventory/index.jsp'>[here]</a>.";
						...
						if (subject != null && !subject.equals("") && !username.equals("") && !mailTo.equals("")){
					       ...
					       response.sendRedirect("/inventory/contact.jsp");
					    }
			        }
				} catch (Exception e) {
			...
			<div style="margin: 0px 0px 0px 15%;">
				<form name=sendmailform method="post" action="/inventory/sendmail.jsp">
					<table >
						<tr bgcolor="#C2D5FC">
							<td>
								Your Name*:
